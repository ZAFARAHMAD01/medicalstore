 ...
 <section style={{ width: "100%", margin: "auto" }}>
   <Container>
     ...
     <Row>
       ...
       <Tabs defaultActiveKey="profile" id="justify-tab-example tablink" className="tab11 " justify >

         <Tab eventKey="home" title="Featured items" className='col-md-12 ' >
           <Row>
             <Col sm>
             <div class="card mt-3 proimg">
               <div class="card-body">
                 <img class="card-img-top w-100" src={log} alt="Card image" style={{ width: "100%" }} />
             ...
             <div class="card mt-3 proimg">
               <div class="card-body">
                 <img class="card-img-top w-100" src={log2} alt="Card image" />
                 <div className='addcard w-100'>
                   <div className='d-flex ADDCARD w-100'>
                 ...
                 <div className='cardpadding'>
                   ...
                   <a href="/products/calories-meter" class="full-unstyled-link">
                     Forehead Thermometer <span class="choosen-swatch">
                       <br />
                     </span>
                   </a>
                   <span class="price-item price-item--regular">
             ...
             <div class="card mt-3 proimg">
               <div class="card-body">
                 <img class="card-img-top" src={log3} alt="Card image" style={{ width: "100%" }} />
                 <div className='addcard w-100'>
                   <div className='d-flex ADDCARD w-100'>
                 ...
                 <div className='cardpadding'>
                   ...
                   <a href="/products/calories-meter" class="full-unstyled-link">
                     Face Mask <span class="choosen-swatch">
                       <br />
                     </span>
                   </a>
                   <span class="price-item price-item--regular">
             ...
             <div class="card mt-3 proimg">
               <div class="card-body">
                 <img class="card-img-top" src={log4} alt="Card image" style={{ width: "100%" }} />
                 <div className='addcard w-100'>
                   <div className='d-flex ADDCARD w-100'>
                 ...
                 <div className='cardpadding'>
                   ...
                   <a href="/products/calories-meter" class="full-unstyled-link">
                     Dental flox box <span class="choosen-swatch">
                       <br />
                     </span>
                   </a>
                   <span class="price-item price-item--regular">
           ...
           <Row>
             ...
             <div class="card mt-3 proimg">
               <div class="card-body">
                 <img class="card-img-top" src={log8} alt="Card image" style={{ width: "100%" }} />
                 <div className='addcard w-100'>
                   <div className='d-flex ADDCARD w-100'>
         ...
         <Tab eventKey="profile" title="Best Seller">
           <Row>
             {/* sending the data another page  */}
             {/* map through send the data or pass the data */}
             {
         ...
         <Tab eventKey="longer-tab" title="Top Rated" disabled>
