...
import { hide } from '../Redux/Auth.jsx';
function Card1(props) {
  const us = useSelector((state) => state.auth.user);
  
  
  
  console.log(props.z1,'z1');
  ...
  const addcards = (name,price, img, id,slug) =>{
    ...
    // console.log(show1,'show');
      ...
      navigate('/checkout',props.data,props.id,show1);
    }
  
    
    // navigate('/Discount',props.data,props.id,show1);
    ...
    props.z1
      ...
      <div className='addcard w-100'>
                ...
                <div className='w-100 '><Button className='w-100 rounded-0 addc' onClick={ ()=>addcards(props.pp.name,props.pp.price, props.pp.imag, props.pp.id,props.pp.slug)} >Add Card</Button></div>
          </div>

        </div>
      <div className='p-4 crdpadding'>

        <Link to={props.pp?.slug} className='product-link'><div className= {props.pp?.nameclassName}>
        {props.pp?.name}
        </div></Link>
  ...
  <g id="Group_25127" data-name="Group 25127" transform="translate(-1083.836 -1161.835)">
    ...
    <line id="Line_322" data-name="Line 322" x2="5.88" transform="translate(1084.586 1172.822)" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-width="1.5"></line>
        ...
        Shipping
                  ...
                  <div onClick={ ()=>discount()}><svg id="Component_63_1" data-name="Component 63 – 1" xmlns="http://www.w3.org/2000/svg" width="29.339" height="21.5" viewBox="0 0 29.339 21.5" class="icon icon-free-shipping">
...
Discount
        ...
        Discount
              ...
              <div className='subtotal'>
                ...
                <div className='mt-3 '>
                  <Button className='w-100 checkout' onClick={()=>Checkout(props.pp.id,props.pp.price,props.pp.quantity)}>Check Out</Button>
                </div>
                <div className='mt-3 '>
        ...
        <div className='discount w-100 p-2' style={{ display: showDiv ? 'block' : 'none' }} >
        
        {

        show4===true?<Discount />:show4==='loginpage'?<Login/>:<></>
        }
        </div>
      </Offcanvas>
